...
const translations = {
  en: {
    ...
    "portfolio.promise.title": "“The Earth Erases everything Except the Promise”",
    "portfolio.promise.date": "March 2026",
    "portfolio.promise.location": "Crémone, 13006 Marseille, France",
    "portfolio.promise.desc": "“The Earth Erases everything Except the Promise” is a conceptual project situated between artistic research and environmental protection, understood as a necessity for existence. The project unfolds in several phases, including a workshop, a round-table discussion, and the realization of the final installation. The culminating exhibition emerges from my research into the concept of regeneration, approached both as a natural process and as a cultural metaphor. Through the use of recyclable materials and artistic interventions, the work reflects on what humanity loses under the pressure of time, as well as on what remains as vital potential. Rather than representing damage, the installation stages an encounter with impermanence, inviting the viewer to reflect on responsibility, care, and the legacy that the earth silently preserves.",
    "portfolio.promise.support": "This project is supported by the Regional office of the Italian Agency for Development Cooperation in Tirana.",
    "portfolio.promise.cc4wbs": "The “Culture and Creativity for the Western Balkans” (CC4WBs) is a project funded by the European Union that aims to foster dialogue in the Western Balkans by enhancing the cultural and creative sectors for increased socio-economic impact.",
...
`,
  ...
  fr: {
    ...
    "portfolio.promise.title": "« La Terre efface tout sauf la promesse »",
    "portfolio.promise.date": "Mars 2026",
    "portfolio.promise.location": "Crémone, 13006 Marseille, France",
    "portfolio.promise.desc": "« La Terre efface tout sauf la promesse » est un projet conceptuel situé entre la recherche artistique et la protection de l'environnement, comprises comme une nécessité pour l'existence. Le projet se déploie en plusieurs phases, comprenant un atelier, une table ronde et la réalisation de l'installation finale. L'exposition qui en résulte naît de mes recherches sur le concept de régénération, abordé à la fois comme processus naturel et comme métaphore culturelle. À travers l'utilisation de matériaux recyclables et d'interventions artistiques, l'œuvre réfléchit à ce que l'humanité perd sous la pression du temps, ainsi qu'à ce qui demeure comme potentiel vital. Plutôt que de représenter les dommages, l'installation met en scène une rencontre avec l'impermanence, invitant le spectateur à réfléchir à la responsabilité, au soin et à l'héritage que la terre préserve silencieusement.",
    "portfolio.promise.support": "Ce projet est soutenu par le Bureau régional de l'Agence italienne pour la coopération au développement à Tirana.",
    "portfolio.promise.cc4wbs": "« Culture et Créativité pour les Balkans occidentaux » (CC4WBs) est un projet financé par l'Union européenne qui vise à favoriser le dialogue dans les Balkans occidentaux en renforçant les secteurs culturels et créatifs afin d'accroître leur impact socio-économique.",
  "portfolio.hypocrisis.desc": `
